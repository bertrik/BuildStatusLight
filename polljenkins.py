...
#
# Polls a Jenkins build server for status over HTTP and pushes the result over serial to a toy traffic light.
#
...
def main():
    # you can run a local HTTP server serving files from the current local directory on port 8000, using
